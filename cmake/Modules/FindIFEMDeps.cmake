  ...
  IF(PETSC_FOUND)
    ...
    IF(IFEM_USE_SLEPC)
      ...
      IF(SLEPC_LIBRARIES AND SLEPC_INCLUDE_DIRS)
        SET(IFEM_DEPINCLUDES ${IFEM_DEPINCLUDES} ${SLEPC_INCLUDE_DIRS})
...
ELSEIF(NOT "${IFEM_USE_SPR}" MATCHES "OFF")
  set(SPR_USE_INT4 TRUE)
ENDIF("${IFEM_USE_SPR}" MATCHES "I64")
IF(SPR_USE_INT4 OR SPR_USE_INT8)
  FIND_PACKAGE(SPR)
  IF(SPR_LIBRARIES)
    list(APPEND IFEM_DEPLIBS ${SPR_LIBRARIES})
    string(APPEND IFEM_BUILD_CXX_FLAGS " -DHAS_SPR")
    IF(SPR_USE_INT8)
      string(APPEND IFEM_BUILD_CXX_FLAGS " -DUSE_INT64")
    ENDIF(SPR_USE_INT8)
    IF(ASM_LIBRARIES)
      string(APPEND IFEM_BUILD_CXX_FLAGS " -DUSE_F77SAM")
    ENDIF(ASM_LIBRARIES)
  ENDIF(SPR_LIBRARIES)
ENDIF(SPR_USE_INT4 OR SPR_USE_INT8)
