...
FUNCTION(IFEM_ADD_TEST name binary)
  ...
  IF(IFEM_TEST_MEMCHECK)
    ADD_TEST("${binary}+${name}" regtest.sh "${MEMORYCHECK_COMMAND} --log-file=valgrindlog ${EXECUTABLE_OUTPUT_PATH}/${binary}" ${PROJECT_SOURCE_DIR}/Test/${name} ${ARGN})
  ELSE(IFEM_TEST_MEMCHECK)
    ADD_TEST("${binary}+${name}" regtest.sh ${EXECUTABLE_OUTPUT_PATH}/${binary} ${PROJECT_SOURCE_DIR}/Test/${name} ${ARGN})
