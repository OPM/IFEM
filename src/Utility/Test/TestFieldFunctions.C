...
TEST(TestFieldFunctions, 2D1P)
{
  ...
  EXPECT_NEAR(lap(1,1), 2.0*x*y*y, 1e-14);
  EXPECT_NEAR(lap(1,2), x*x*x*2.0/3.0, 1e-14);
...
TEST(TestFieldFunctions, 2D1Pmx)
{
  // Fields contains: u_x = x^3*y^2 / 3
  //                  u_y = -x^2*y^3 / 3
  //                    p = x^2*y^2
...
TEST(TestFieldFunctions, 3D1P)
{
  ...
  EXPECT_NEAR(ten(1,1), x*x*y*y*z*z, 1e-14);
  EXPECT_NEAR(ten(1,2), x*x*x*2.0*y*z*z / 3.0, 1e-14);
  EXPECT_NEAR(ten(1,3), x*x*x*y*y*2.0*z / 3.0, 1e-14);
  EXPECT_NEAR(ten(2,1), 2*x*y*y*y*z*z / 3.0, 1e-14);
  EXPECT_NEAR(ten(2,2), x*x*y*y*z*z, 1e-14);
  EXPECT_NEAR(ten(2,3), x*x*y*y*y*2.0*z / 3.0, 1e-14);
  EXPECT_NEAR(ten(3,1), -2.0*2.0*x*y*y*z*z*z / 3.0, 1e-14);
  EXPECT_NEAR(ten(3,2), -2.0*x*x*2.0*y*z*z*z / 3.0, 1e-14);
  EXPECT_NEAR(ten(3,3), -2.0*x*x*y*y*z*z, 1e-14);
  ...
  EXPECT_NEAR(sten(1,1), x*x*y*y*z*z, 1e-14);
  EXPECT_NEAR(sten(1,2), x*x*x*2.0*y*z*z / 3.0, 1e-14);
  EXPECT_NEAR(sten(1,3), x*x*x*y*y*2.0*z / 3.0, 1e-14);
  EXPECT_NEAR(sten(2,1), 2.0*x*y*y*y*z*z / 3.0, 1e-14);
  EXPECT_NEAR(sten(2,2), x*x*y*y*z*z, 1e-14);
  EXPECT_NEAR(sten(2,3), -2.0*x*x*2.0*y*z*z*z / 3.0, 1e-14);
  EXPECT_NEAR(sten(3,1), x*x*x*y*y*2.0*z / 3.0, 1e-14);
  EXPECT_NEAR(sten(3,2), -2.0*x*x*2.0*y*z*z*z / 3.0, 1e-14);
  EXPECT_NEAR(sten(3,3), -2.0*x*x*y*y*z*z, 1e-14);
}


TEST(TestFieldFunctions, 3D1Pmx)
{
  // Fields contains: u_x = x^3*y^2*z^3 / 3
  //                  u_y = -x^2*y^3*z^3 / 3
  //                  u_z = -2*x^2*y^2*z^3 / 3
