...
TEST(TestDomainDecomposition, LocalGroups1DO1)
{
  ...
  check_intmatrices_equal(dd, "src/ASM/Test/refdata/DomainDecomposition_1D_O1.ref");
}
...
TEST(TestDomainDecomposition, LocalGroups1DO2)
{
  ...
  check_intmatrices_equal(dd, "src/ASM/Test/refdata/DomainDecomposition_1D_O2.ref");
}
...
TEST(TestDomainDecomposition, LocalGroups2DO1)
{
  ...
  check_intmatrices_equal(dd, "src/ASM/Test/refdata/DomainDecomposition_2D_O1.ref");
}
...
TEST(TestDomainDecomposition, LocalGroups2DO2)
{
  ...
  check_intmatrices_equal(dd, "src/ASM/Test/refdata/DomainDecomposition_2D_O2.ref");
}
...
TEST(TestDomainDecomposition, LocalGroups3DO1)
{
  ...
  check_intmatrices_equal(dd, "src/ASM/Test/refdata/DomainDecomposition_3D_O1.ref");
}
...
TEST(TestDomainDecomposition, LocalGroups3DO2)
{
  ...
  check_intmatrices_equal(dd, "src/ASM/Test/refdata/DomainDecomposition_3D_O2.ref");
}
