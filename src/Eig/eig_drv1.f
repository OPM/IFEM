      subroutine eig_drv1 (n,nev,ncv,d,v,work,ierr)
c
c $Id: eig_drv1.f,v 1.1 2009-12-08 15:32:49 kmo Exp $
c-----------------------------------------------------------------------
c\BeginDoc
c
c\Name: eig_drv1
...
c     reverse communication interface in ARPACK, regular mode.
c     This subroutine is based on the test driver DSDRV1 from the
...
c
c\Usage:
c  call eig_drv1 ( N, NEV, NCV, D, V, WORK, IERR )
c
c\Arguments
c  N       Integer.  (INPUT)
...
c     | iterations allowed.  Mode 1 specified in the      |
c     | documentation of DSAUPD is used (IPARAM(7) = 1).  |
